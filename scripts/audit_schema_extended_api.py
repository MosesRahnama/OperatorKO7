...
EXTENDED_ROOT = REPO_ROOT / "OperatorKO7" / "SchemaExtendedAPI.lean"
...
FORBIDDEN_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    ("BenchmarkedPrimitiveRecursionFamily", re.compile(r"\bBenchmarkedPrimitiveRecursionFamily\b")),
    ("ConfessionMethod_Family", re.compile(r"\bConfessionMethod_Family\b")),
    ("MetaHalt", re.compile(r"\bMetaHalt\b")),
]
...
def main() -> int:
    closure = import_closure(EXTENDED_ROOT)
    ...
    if not violations:
        print("\nAudit result: PASS")
        print("No forbidden KO7-facing or cross-paper tokens were found in code outside comments/strings.")
        return 0
